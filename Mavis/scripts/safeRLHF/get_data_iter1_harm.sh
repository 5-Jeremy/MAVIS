...
DATA_AMOUNT=3008
BETA=2.5
LOGFILE=Training_Output/safeRLHF/iter1_logs/get_data_harm.log
mkdir -p Training_Output/safeRLHF/iter1_logs/

UNLABELED_DIR=Training_Output/safeRLHF/unlabeled_data/iter1/harm
...
bash scripts/get_data_iter_full_utilization.sh safeRLHF_harm $START_PROMPT $DATA_AMOUNT $UNLABELED_DIR $BETA 0 &>> $LOGFILE
