...
if __name__ == "__main__":
    eval_loop(inputs, prompt_indices, args.num_trials, best_of_n, reward_model, rm_device, get_rewards, obj_weights=obj_weights,
              verbose=True, track_time=args.track_time, file_name=file_name, seed=args.seed)